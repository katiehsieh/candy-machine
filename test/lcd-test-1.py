...
lcd_rs = digitalio.DigitalInOut(board.D25)  # pin 4
lcd_en = digitalio.DigitalInOut(board.D24)  # pin 6
lcd_d7 = digitalio.DigitalInOut(board.D22)  # pin 14
lcd_d6 = digitalio.DigitalInOut(board.D18)  # pin 13
lcd_d5 = digitalio.DigitalInOut(board.D17)  # pin 12
lcd_d4 = digitalio.DigitalInOut(board.D23)  # pin 11
